...
(function (core ) {
    ...
    class Contact {
        ...
        /**
         * Set the full name of the contact a validates the input to ensure it's a non-empty string.
         * @param fullName
         */
        ...
        /**
         * Sets the contact number of the contact. Validates the input to ensure it matches 10 digit format
         * @param contactNumber
         */

        set contactNumber(contactNumber) {
            const phoneRegex = /^\d{3}-\d{3}-\d{4}$/; //905-123-1234
        ...
        set emailAddress(address) {
            ...
            if (!emailRegex.test(address)) {
                throw new Error("Invalid email address: must be a non-empty string"); // basic email format
            }
